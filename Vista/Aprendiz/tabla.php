...
$sql = "SELECT * FROM VISTA_APRENDIZ";
        ...
        <thead style="background-color: #005f60; color: white; font-weigth: bold;">
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <span class="btn btn-warning btn-sm" data-toggle="modal" data-target="#Modal-editar-Aprendiz" onclick="obtenDatos('<?php echo $mostrar[0]; ?>')" >
