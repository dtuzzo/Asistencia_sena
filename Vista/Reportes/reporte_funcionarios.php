...
function Header()
{
    ...
    $this->Cell(40, 12, utf8_decode('Documento'), 1, 0, 'C', 1);
    $this->Cell(50, 12, 'Nombre', 1, 0, 'C', 1);
    $this->Cell(50, 12, 'Apellido', 1, 0, 'C', 1);
    $this->Cell(20, 12, 'Celular', 1, 0, 'C', 1);
    $this->Cell(20, 12, 'Rol', 1, 1, 'C', 1);
}
...
while ($row = $resultado-> fetch_assoc()){
    ...
    $pdf->Cell(40, 10, utf8_decode($row['numerodocumento_funcionario']), 1, 0, 'C', 0);
    $pdf->Cell(50, 10, utf8_decode($row['nombre_funcionario']), 1, 0, 'C', 0);
    $pdf->Cell(50, 10, utf8_decode($row['apellido_funcionario']), 1, 0, 'C', 0);
    $pdf->Cell(20, 10, utf8_decode($row['celular_funcionario']), 1, 0, 'C', 0);
    $pdf->Cell(20, 10, utf8_decode($row['id_rol_fk']), 1, 1, 'C', 0);
}
