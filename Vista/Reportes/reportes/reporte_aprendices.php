...
{   
    ...
    $this->Cell(10, 12, 'Estado', 1, 0, 'C', 1);
    $this->Cell(10, 12, 'Ficha', 1, 1, 'C', 1);
}
...
while ($row = $resultado-> fetch_assoc()){
    ...
    $pdf->Cell(8, 10, $row['id_aprendiz'], 1, 0, 'C', 0);
    ...
    $pdf->Cell(10, 10, utf8_decode($row['id_estado_fk']), 1, 0, 'C', 0);
    $pdf->Cell(10, 10, utf8_decode($row['id_ficha_fk']), 1, 1, 'C', 0);
}
